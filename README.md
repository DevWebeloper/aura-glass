...
[**v0.2.2-beta**][beta] is out — the new settings window, three glass modes, the first-run wizard, and installable interface fonts. It is a prerelease: expect rough edges, and stick to the [latest stable release][releases] if you would rather not hit them.
