...
[**v0.2.1-beta**][beta] is out — the new settings window, three glass modes, the first-run wizard, installable interface fonts, and a settings window that opens itself once after install. It is a prerelease: expect rough edges, and stick to the [latest stable release][releases] if you would rather not hit them.
